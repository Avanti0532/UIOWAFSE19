Feature: Student can view/search universities
  ...
  @javascript
  Scenario: Student can search courses
    When I log in as a student
    And I search courses with Database Systems
    Then I should see only search result with Database Systems

  Scenario: Student should see course information when view button is clicked
    When I log in as a student
    And I click on view link of Database Systems
    Then I should be able to see Database Systems information
