Feature: Student can register for courses
  Background:
    ...
    Given the following courses have been added to Course Database:
      ...
      |Principles of Computing  |2|3|400|This course provides an introduction to the design and implementation of modern operating systems. Students will learn how the operating system manages devices including I/O systems, secondary storage, and peripherals.                                                                                                                                                                                                   |3:30P - 4:45P TTh  |
    Given the following prerequisites have been added to Prerequisite Database:
    |course_id|prereq_id|
    |2        |1        |
    |3        |4        |

    Given the following enrollments have been added to Enrollment Database:
    |course_id|student_id|registration_datetime|
    |4        |1         |2019-12-07           |

  @javascript
  Scenario: Student can register for courses
    When I log in as a student
    And I click on view link of Database Systems
    And I click on register
    Then I should be successfully registered

  @javascript
  Scenario: Student cannot register for courses when prerequisite is not completed
    When I log in as a student
    And I click on view link of Information Visualization
    And I click on register
    Then I should receive error message

  @javascript
  Scenario: Student can register for courses when prerequisite is completed
    When I log in as a student
    And I click on view link of Operating Systems
    And I click on register
    Then I should be successfully registered

  @javascript
  Scenario: Student can see registered courses
    When I log in as a student
    And I click on view link of Database Systems
    And I click on register
    Then I should see the course in registered course section
